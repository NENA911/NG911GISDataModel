...
This release of the **NENA NG9-1-1 GIS Data Model Templates** is in alignment with NENA's NG9-1-1 Data Model ([NENA-STA-006.3-YYYY](https://github.com/NENA911/NG911GISDataModel/blob/main/docs/nena-sta-006.3-2026_ng9-1-1.pdf)) adopted by NENA DSC on YYYY-MM-DD.
...
- Redefined “Type” column that indicates the data type of the attribute columns in all layers.
  ...
  - INTEGER field type replaces field type NF.
  - REAL (Precision, Scale) field type replaces field type FN.
...
- RailroadCenterLine layer
  ...
  - Changed type for Rail Mile Post Hight field.
...
This release of the **NENA NG9-1-1 GIS Data Model Templates** is in alignment with NENA's NG9-1-1 Data Model ([NENA-STA-006.2a-2023](https://github.com/NENA911/NG911GISDataModel/blob/main/docs/nena-sta-006.2a-2023_ng9-1-1.pdf)) adopted by NENA DSC on 2023-05-02. There was one minor code change in the PostgreSQL template due to an invalid domain range in the Speed Limit field as the majority of the errata changes were already part of v2.0 release.

---

## v2.0 - 2023-03-21
 
This release of the **NENA NG9-1-1 GIS Data Model Templates** are based on NENA's NG9-1-1 Data Model ([NENA-STA-006.2-2022](https://github.com/NENA911/NG911GISDataModel/blob/main/docs/nena-sta-006.2-2022_ng9-1-1.pdf)). This release includes errata changes to NENA-STA-006.2-2022 to be adopted as NENA-STA-006.2a-2023.
...
Initial release is a direct import of the **NG911_GIS_TEMPLATE_FILES_20200521** from [NG9-1-1 GIS Data Model](https://www.nena.org/page/NG911GISDataModel). It was used as the initial baseline for this repository.

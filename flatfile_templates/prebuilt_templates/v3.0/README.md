# NG9-1-1 GIS Data Model v3.0 Pre-Built Templates

This folder contains the NENA NG9-1-1 GIS Data Model pre-built templates for the v3.0 release.
...
* [NG911_GISDataModelTemplate_v3.0.gpkg.xml](NG911_GISDataModelTemplate_v3.gpkg.xml) - GeoPackage (GPKG) Metadata file.
